		...
		<div class="row clearfix">
			<div class="col-md-12 column" style="padding: 0px;">
				<form class="form-horizontal" role="form" style="margin-top: 50px ;"
						action="AddGoodsServlet" method="GET" onsubmit="return validate();">
					<div class="form-group" style="margin-left: 20%;">
						 <label for="inputEmail3" class="col-sm-2 control-label">产品编号</label>
						<div class="col-sm-10" style="width: 50%;">
							<input type="text" class="form-control" value="eg:12"
								name="gid" >
						</div>
					</div>
					<div class="form-group" style="margin-left: 20%;">
						...
						<div class="col-sm-10" style="width: 50%;">
							<input type="text" class="form-control" value="eg:XXX"
								name="gname" >
						</div>
					</div>
					<div class="form-group" style="margin-left: 20%;">
						...
						<div class="col-sm-10" style="width: 50%;">
							<input type="text" class="form-control" value="eg:12.235"
								name="gprice" >
						</div>
					</div>
					<div class="form-group" style="margin-left: 20%;">
						...
						<div class="col-sm-10" style="width: 50%;">
							<input type="text" class="form-control" value="eg:XXXXXX"
								name="gintroduce" >
						</div>
					</div>
					<div class="form-group" style="margin-left: 20%;">
						...
						<div class="col-sm-10" style="width: 50%;">
							<input type="hidden" id="area_content" value="eg:XXXXXXX,XXXXXXXXX"
								 >
